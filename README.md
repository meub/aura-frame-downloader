...
1. **Download** the latest release: [Aura-Downloader-macOS-arm64.zip](https://github.com/meub/aura-frame-downloader/releases/latest/download/Aura-Downloader-macOS-arm64.zip)
